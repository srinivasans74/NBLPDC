...
void read_data() {
	...
	if (Q == 4){
		...
		fp_gamma = fopen("C:/Users/mtech/Desktop/Oscar ferraz/NB_LDPC-master/nbldpc-cpu_ubuntu/random_data/Q8/symbol_llr.txt", "r");

	}
	else if (Q == 16){

		fp_gamma = fopen("C:/Users/mtech/Desktop/Oscar ferraz/NB_LDPC-master/nbldpc-cpu_ubuntu/random_data/Q16/symbol_llr.txt", "r");

	}
	else if (Q == 32){

			fp_gamma = fopen("C:/Users/mtech/Desktop/Oscar ferraz/NB_LDPC-master/nbldpc-cpu_ubuntu/random_data/Q32/symbol_llr.txt", "r");
