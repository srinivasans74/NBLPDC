...
extern int		H_nb[U][V];
extern int		G_nb[U][V];
extern int		row_weight[U];
extern int		col_weight[V];
extern int		col_row[U][Y];
extern int		row_col[X][V];
extern unsigned char	BETAmn[U][V][Q];
extern unsigned char	ALPHAmn[U][V][Q];
//extern unsigned char	GAMMAn[Q][V];
extern int	encoded_sym[V];
