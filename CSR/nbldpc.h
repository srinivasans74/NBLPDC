...
extern unsigned char	H_nb[U][V];
extern unsigned char	val[nnnz];
extern unsigned short	row_ptr[U+1];
extern unsigned short	col_ind[nnnz];
extern unsigned short	row_ind[nnnz];
extern unsigned short	col_ptr[V+1];
extern unsigned short	ptr_to_val[nnnz];
extern unsigned short	row_weight[U];
extern unsigned short	col_weight[V];
//extern unsigned char	**BETAmn;
//extern unsigned char	**ALPHAmn;
extern unsigned char	GAMMAn[Q][V];
extern unsigned char    encoded_sym[V];
extern unsigned char	GAMMAn_post[Q][V];
extern unsigned short 	nnz;


extern int				row_col[X][V];
extern int				col_row[U][Y];
#endif
