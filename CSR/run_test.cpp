...
unsigned char	H_nb[U][V];
unsigned short	row_weight[U];
unsigned short	col_weight[V];
unsigned short   G_nb[U][V];
unsigned char	val[nnnz];
unsigned short	row_ptr[U+1];
unsigned short	col_ind[nnnz];
unsigned short	row_ind[nnnz];
unsigned short	col_ptr[V+1];
unsigned short	ptr_to_val[nnnz];
...
void qc_gen(void)
{
	...
	FILE *fp_params = fopen("C:/Users/mtech/Desktop/Srini/param.txt", "w+");
...
void read_data() {
	...
	if (Q == 4){
		...
		fp_encoded = fopen("random_data/Q4/encoded_sym.nb.txt", "r");
	...
	/* else if (Q == 8){
		...
		fp_gamma = fopen("random_data/Q8_extra/symbol_llr.txt", "r");
		fp_encoded = fopen("random_data/Q8_extra/encoded_sym.nb.txt", "r");
		fp_row_ind = fopen("random_data/Q8_extra/row_ind.txt", "r");
	} */
		...
		fp_encoded = fopen("random_data/Q8/encoded_sym.nb.txt", "r");
		...
		fp_gamma = fopen("C:/Users/mtech/Desktop/required_files/Q16", "r");
...
void read_data2() {
	...
	if (Q == 4){
		...
		fp_ptr_to_val = fopen("random_data/Q8_extra/ptr_to_val.txt", "r");
		fp_row_ind = fopen("random_data/Q8_extra/row_ind.txt", "r");
		fp_gnb = fopen("random_data/Q8_extra/gnb.txt", "r");
	}
	else if (Q == 16){
		fp_params = fopen("random_data/Q16/params.txt", "r");
		fp_row_weight = fopen("random_data/Q16/row_weight.txt", "r");
