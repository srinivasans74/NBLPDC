...
{
#pragma HLS ARRAY_PARTITION variable=GAMMAn_ block factor=4 dim=2
...
//#pragma HLS RESOURCE variable=BETAmn_1 core=RAM_2P_LUTRAM
//#pragma HLS RESOURCE variable=GAMMAn_ core=RAM_2P_BRAM
//#pragma HLS RESOURCE variable=ALPHAmn_1 core=RAM_2P_LUTRAM
//#pragma HLS ARRAY_PARTITION variable=ALPHAmn_1 complete dim=3
#pragma HLS INTERFACE m_axi depth=1200 port=GAMMAn_
//#pragma HLS ARRAY_PARTITION variable=BETAmn_1 complete dim=3
...
#pragma HLS ARRAY_PARTITION variable=codeword_sym block factor=10 dim=1
	unsigned char B[Q][Y];
	unsigned char F[Q][Y];
